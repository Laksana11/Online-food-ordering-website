   ...
   <table>
      ...
      <tr>
         ...
         <td>
            ...
            <input type="submit" name="take_order"  style="background-color:<?php if($fetch_orders['order_taken'] == 'Yes'){ echo 'rgb(45, 155, 43)'; } ?>" class="order-btn" value="<?php echo $fetch_orders['order_taken']; ?>"/>
            </form>
